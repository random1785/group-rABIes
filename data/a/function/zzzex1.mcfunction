...
execute as @e[tag=score,scores={ex=1,round=1,scoretick=0..1250}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"aqua"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=1251..2500}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"green"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=2501..3750}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"yellow"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=3751..5000}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"gold"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=5001..6250}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"red"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=6251..7500}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"dark_red"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=7501..8750}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"dark_gray"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=8751..10000}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"black"}

execute as @e[tag=score,scores={ex=1,round=1,scoretick=0..1250}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"aqua"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=1251..2500}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"green"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=2501..3750}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"yellow"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=3751..5000}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"gold"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=5001..6250}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"red"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=6251..7500}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"dark_red"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=7501..8750}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"dark_gray"}
execute as @e[tag=score,scores={ex=1,round=1,scoretick=8751..10000}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"black"}
