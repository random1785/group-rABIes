...
execute as @e[tag=score,scores={ex=3,round=1,scoretick=0..500}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"aqua"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=501..1000}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"green"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=1001..1500}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"yellow"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=1501..2000}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"gold"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=2001..2500}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"red"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=2501..3000}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"dark_red"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=3001..3500}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"dark_gray"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=3501..4000}] run title @a[tag=spec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"black"}

execute as @e[tag=score,scores={ex=3,round=1,scoretick=0..500}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"aqua"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=501..1000}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"green"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=1001..1500}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"yellow"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=1501..2000}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"gold"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=2001..2500}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"red"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=2501..3000}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"dark_red"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=3001..3500}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"dark_gray"}
execute as @e[tag=score,scores={ex=3,round=1,scoretick=3501..4000}] run title @a[tag=pspec] actionbar {"score":{"name":"@s","objective":"scoretick"},"color":"black"}
