...
execute as @e[scores={message=29}] run tellraw @a {"text":"Goal: [What a Deal!]","color":"red","hover_event":{"action":"show_text","value":{"text":"What a Deal!\nTrade with a villager","color":"gold"}}}
execute as @e[scores={message=30}] run tellraw @a {"text":"Goal: [Ice Bucket Challenge]","color":"red","hover_event":{"action":"show_text","value":{"text":"Ice Bucket Challenge\nGet obsidian","color":"gold"}}}
execute as @e[scores={message=31}] run tellraw @a {"text":"Goal: [Mob Kebab]","color":"red","hover_event":{"action":"show_text","value":{"text":"Mob Kebab\nHit 5 entities with the charge attack of the spear.","color":"gold"}}}

execute as @e[scores={message=32}] run tellraw @a {"text":"Goal: [Ol' Betsy]","color":"red","hover_event":{"action":"show_text","value":{"text":"Ol' Betsy\nShoot a crossbow","color":"gold"}}}
execute as @e[scores={message=33}] run tellraw @a {"text":"Goal: [Crafters Crafting Crafters]","color":"red","hover_event":{"action":"show_text","value":{"text":"Crafters Crafting Crafters\nBe near a Crafter that crafts a Crafter","color":"gold"}}}
execute as @e[scores={message=34}] run tellraw @a {"text":"Goal: [Tactical Fishing]","color":"red","hover_event":{"action":"show_text","value":{"text":"Tactical Fishing\nCatch a fish with a bucket","color":"gold"}}}
execute as @e[scores={message=35}] run tellraw @a {"text":"Goal: [We Need To Go Deeper]","color":"red","hover_event":{"action":"show_text","value":{"text":"We Need To Go Deeper\nEnter the nether","color":"gold"}}}
execute as @e[scores={message=36}] run tellraw @a {"text":"Goal: [Cover Me With Diamonds]","color":"red","hover_event":{"action":"show_text","value":{"text":"Cover Me With Diamonds\nGet diamond armor","color":"gold"}}}
execute as @e[scores={message=37}] run tellraw @a {"text":"Goal: [Respecting Remnants]","color":"red","hover_event":{"action":"show_text","value":{"text":"Respecting Remnants\nBrush a suspicious block to get a sherd","color":"gold"}}}
execute as @e[scores={message=38}] run tellraw @a {"text":"Goal: [Careful Restoration]","color":"red","hover_event":{"action":"show_text","value":{"text":"Careful Restoration\nMake a pot with 4 sherds","color":"gold"}}}
execute as @e[scores={message=39}] run tellraw @a {"text":"Goal: [Sneak 100]","color":"red","hover_event":{"action":"show_text","value":{"text":"Sneak 100\nShift near a skulk sensor","color":"gold"}}}
execute as @e[scores={message=40}] run tellraw @a {"text":"Goal: [Light as a Rabbit]","color":"red","hover_event":{"action":"show_text","value":{"text":"Light as a Rabbit\nWalk (not sink) on powdered snow","color":"gold"}}}
execute as @e[scores={message=41}] run tellraw @a {"text":"Goal: [Isn't it Scute?]","color":"red","hover_event":{"action":"show_text","value":{"text":"Isn't it Scute?\nBrush an armadillo","color":"gold"}}}
execute as @e[scores={message=42}] run tellraw @a {"text":"Goal: [Whatever Floats Your Goat!]","color":"red","hover_event":{"action":"show_text","value":{"text":"Whatever Floats Your Goat!\nGet in a boat with a goat","color":"gold"}}}
execute as @e[scores={message=43}] run tellraw @a {"text":"Goal: [Country Lode, Take Me Home]","color":"red","hover_event":{"action":"show_text","value":{"text":"Country Lode, Take Me Home\nUse a compass on a lodestone","color":"gold"}}}
execute as @e[scores={message=44}] run tellraw @a {"text":"Goal: [The Cutest Predator]","color":"red","hover_event":{"action":"show_text","value":{"text":"The Cutest Predator\nGet an axolotl in a bucket","color":"gold"}}}

execute as @e[scores={message=46}] run tellraw @a {"text":"Goal: [The Power of Books]","color":"red","hover_event":{"action":"show_text","value":{"text":"The Power of Books\nPlace a comparator next to a chiseled bookshelf","color":"gold"}}}
execute as @e[scores={message=47}] run tellraw @a {"text":"Goal: [Sniper Duel]","color":"red","hover_event":{"action":"show_text","value":{"text":"Sniper Duel\nKill a skeleton from 50 blocks (horizontal) away","color":"gold"}}}
execute as @e[scores={message=48}] run tellraw @a {"text":"Goal: [Is It A Bird?]","color":"red","hover_event":{"action":"show_text","value":{"text":"Is It A Bird?\nLook at a parrot through a spyglass","color":"gold"}}}
execute as @e[scores={message=49}] run tellraw @a {"text":"Goal: [Voluntary Exile]","color":"red","hover_event":{"action":"show_text","value":{"text":"Voluntary Exile\nKill a banner pillager","color":"gold"}}}
execute as @e[scores={message=50}] run tellraw @a {"text":"Goal: [Who's the Pillager Now?]","color":"red","hover_event":{"action":"show_text","value":{"text":"Who's the Pillager Now?\nKill a pillager witha crossbow","color":"gold"}}}
execute as @e[scores={message=51}] run tellraw @a {"text":"Goal: [Those Were the Days]","color":"red","hover_event":{"action":"show_text","value":{"text":"Those Were the Days\nEnter a Bastion Remnant","color":"gold"}}}
execute as @e[scores={message=52}] run tellraw @a {"text":"Goal: [A Terrible Fortress]","color":"red","hover_event":{"action":"show_text","value":{"text":"A Terrible Fortress\nEnter a Nether Fortress","color":"gold"}}}
execute as @e[scores={message=53}] run tellraw @a {"text":"Goal: [Oh Shiny]","color":"red","hover_event":{"action":"show_text","value":{"text":"Oh Shiny\nDistract a Piglin with gold","color":"gold"}}}
execute as @e[scores={message=54}] run tellraw @a {"text":"Goal: [Who is Cutting Onions?]","color":"red","hover_event":{"action":"show_text","value":{"text":"Who is Cutting Onions?\nGet crying obsidian","color":"gold"}}}
execute as @e[scores={message=55}] run tellraw @a {"text":"Goal: [Into Fire]","color":"red","hover_event":{"action":"show_text","value":{"text":"Into Fire\nGet a Blaze Rod","color":"gold"}}}
execute as @e[scores={message=56}] run tellraw @a {"text":"Goal: [Hot Tourist Destinations]","color":"red","hover_event":{"action":"show_text","value":{"text":"Hot Tourist Destinations\nVisit all 5 nether biomes","color":"gold"}}}
